...
def get_img_brisque_score(filename, img_size_qual_):
    img = load_img(filename, target_size=(img_size_qual_, img_size_qual_))
...
# test = compute_resize_quality_img('test_img.jpg', img_size_qual=150, desired_size=1024)
# test['temp_resize_img']