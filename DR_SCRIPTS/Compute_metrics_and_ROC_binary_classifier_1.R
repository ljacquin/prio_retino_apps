...
model=load_model_hdf5('../DR_APPS/PRIO_RETINO_MODELS/xception_binary_classifier_1_full_arch_avg_pool_ratio_10_1_epochs_11.h5')
...
writeLines(sample(Vect_id_non_rDR,size=500,replace=FALSE), '../DR_RESULTS/Non_rDR_images.txt')

Vect_id_rDR_false_pred<-Test_image_labels$image_id[ which( (Vect_true_class=='rDR')&(Vect_pred_class=='non_rDR') ) ]
writeLines(Vect_id_rDR_false_pred, '../DR_RESULTS/Vect_id_rDR_false_pred')
