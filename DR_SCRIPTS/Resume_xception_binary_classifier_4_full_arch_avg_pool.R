...
model<-load_model_hdf5('../DR_APPS/PRIO_RETINO_MODELS/xception_binary_classifier_4_full_arch_avg_pool.h5')
...
save_model_hdf5(model, filepath=paste0('../DR_APPS/PRIO_RETINO_MODELS/xception_binary_classifier_4_full_arch_avg_pool.h5'))
