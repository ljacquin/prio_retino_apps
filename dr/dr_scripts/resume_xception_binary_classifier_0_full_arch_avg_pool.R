...
model<-load_model_hdf5('../dr_models/xception_binary_classifier_0_full_arch_avg_pool.h5')
...
history <- model %>% fit_generator(
  ...
  class_weight = list( '0'=Vect_weight_per_class[1]*class_2_factor, '1'=Vect_weight_per_class[2] )
)

save_model_hdf5(model, filepath=paste0('../dr_models/xception_binary_classifier_0_full_arch_avg_pool.h5'))
