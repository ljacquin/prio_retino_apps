...
model<-load_model_hdf5('../dr_models/xception_binary_classifier_1_full_arch_avg_pool.h5')
...
save_model_hdf5(model, filepath=paste0('../dr_models/xception_binary_classifier_1_full_arch_avg_pool.h5'))
