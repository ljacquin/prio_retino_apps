...
model<-load_model_hdf5('../glauco_model/xception_binary_classifier_5_full_arch_avg_pool.h5')
...
model %>% compile(
  ...
  #optimizer = optimizer_adam(lr=0.01, beta_1=0.9, beta_2=0.999, epsilon=NULL),
